...
fn test_serealizing_offer_signal() {
    ...
    assert_eq!(&serde_json::to_string(&offer_signal_struct).unwrap(), offer_signal_text);
}
...
fn test_serializing_answer_signal() {
    ...
    assert_eq!(&serde_json::to_string(&answer_signal_struct).unwrap(), answer_signal_text);
}
...
fn test_serializing_new_ice_candidate_signal() {
    ...
    assert_eq!(&serde_json::to_string(&new_ice_candidate_struct).unwrap(), ice_candidate_text);
}
...
fn test_serializing_assign_message() {
    ...
    assert_eq!(&serde_json::to_string(&assign_message_struct).unwrap(), assign_message_text);
}
